...
const aliens = {
    ...
    'tribbles':{
        ...
        'features':'Known for their prodigious reproductive rate, these round, furry creatures emitted cooing sounds while touched, which had a tranquilizing effect on the Human nervous system.',
        'interestingFact': 'An entire half of a tribble\'s metabolism was solely devoted to reproduction and they are born pregnant.' ,
        'notableExamples' : "The Touble with Tribbles",
        'image': 'https://upload.wikimedia.org/wikipedia/en/5/50/ST_TroubleWithTribbles.jpg'
    }
}
